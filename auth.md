...
## NPM web auth
```
npm login --registry=https://usw1.packages.company.com/artifactory/api/npm/project/ --auth-type=web
npm notice Log in on https://usw1.packages.company.com/artifactory/api/npm/project/
Login at:
https://usw1.packages.company.com/ui/auth-provider/npm?uuid=ABC123ABC123ABC123
Press ENTER to open in the browser...
Logged in on https://usw1.packages.company.com/artifactory/api/npm/project/.
---
...
Log in by visiting this link:
    ...
    https://tpe-sb-be-tanzuhub.lvn.company.net/auth/oauth/authorize?client_id=tp_cli_app&code_challenge=ABC123&code_challenge_method=ABC&redirect_uri=http%3A%2F%2F127.0.0.1%3A49759%2Fcallback&response_type=code&state=ABC123
